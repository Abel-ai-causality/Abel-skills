    ...
    result.update(
        {
            ...
            "next_step": (
                ...
                "# runs live graph discovery; then choose a direct candidate/control or optional first-look scout that ranks plausible target, graph, and construction shapes; prepare-branch before trusting data"
            ),
        }
    )
    return result
