...
def build_context_guide_markdown(
    *,
    ...
    lines = [
        ...
        "- the session scout budget is first-look plus at most one narrow refinement tied to one recorded blocker or top family; after that stop scouting and submit a fixed branch, control, fixed model/ensemble construction, or stop/report",
        "- a near-pass, graph expansion, or model-capacity idea can justify recorded work, but should not start another scratch-grid scout unless the user explicitly asks for extra private search",
