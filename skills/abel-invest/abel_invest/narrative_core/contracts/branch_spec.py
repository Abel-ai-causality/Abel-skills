...
def build_context_guide_markdown(
    *,
    ...
    lines = [
        ...
        "- `ScoutRun` tracks one cumulative scout runtime budget per recorded-round interval; when the budget is exhausted or scout is done, stop private scout for that interval and turn current artifacts into a concrete branch",
