...
[[IF_INCLUDE_INTERVENTION]]
    def intervene(self, treatment_node: str, treatment_value: float, outcome_node: str) -> float:
        coefficient = self._effects.get((treatment_node, outcome_node), 0.0)
        return round(coefficient * treatment_value, 4)
[[END_IF_INCLUDE_INTERVENTION]]
[[IF_INCLUDE_INTERVENTION_STUB]]
    def intervene(self, treatment_node: str, treatment_value: float, outcome_node: str) -> float:
        raise NotImplementedError(
            "TODO: wire an SCM, simulator, or internal intervention service before mounting intervene.do."
        )
[[END_IF_INCLUDE_INTERVENTION_STUB]]
